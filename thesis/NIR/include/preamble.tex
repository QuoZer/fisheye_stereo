...
\pdfcommentsetup{draft} % set to 'final' to prevent all comments from showing up   draft
...
\titleformat{\section}{\bfseries}{}{0mm}{\centering{\thesection\quad\textbf{#1}}}   % \titleformat{\section}{}{}{12.5mm}{\centering{\thesection\quad\MakeTextUppercase{#1}}\vspace{1.5em}}
